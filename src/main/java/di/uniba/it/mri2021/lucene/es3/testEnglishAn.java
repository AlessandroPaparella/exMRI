...
public class testEnglishAn {
	public testEnglishAn() {
	}
	...
	public static void main(String[] args)throws Exception {
		...
		outFile = new PrintWriter(new FileWriter("./resources/cran/resultsEnglish.out"));
		...
		for(CollectionLoader.MyQuery q : loader.querySet) {
			...
			for (ScoreDoc sdoc : topdocs.scoreDocs) {
				...
				outFile.println(id_q+" 0 "+searcher.doc(sdoc.doc).get("id")+" "+rank+" "+sdoc.score+" EnglishAnalyzer");
				rank++;
            }
			id_q++;
		}
